...
struct ObservationsTable {
    ...
    public static let INTERNAL_ID_OBSERVATION = Expression<Int64?>("internal_id_observation")
    ...
    public static let OBSERVATION_TIME_STAMP = Expression<Date>("observation_time_stamp")
    ...
    public static let LAST_SYNCED_TIME = Expression<Date?>("last_synced_time")
