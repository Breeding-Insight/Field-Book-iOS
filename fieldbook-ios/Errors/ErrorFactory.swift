...
struct ErrorFactory {
    ...
    static let AppAuthNamespace = "org.phenoapps.fieldbook"
    ...
    static func fromApiRequestError(error: Error, url: String) -> UIError {
        ...
        uiError = UIError(
            ...
            userMessage: "A network problem occurred when calling the server")
    ...
    static func fromApiResponseError(response: HTTPURLResponse, data: Data?, url: String) -> UIError {
        ...
        let error = UIError(
            ...
            userMessage: "A technical problem occurred when calling the server")
