...
public struct ObservationNewRequest: Codable {
    ...
    public var season: ObservationSeason?
    ...
    public init(additionalInfo: [String:String]? = nil, collector: String? = nil, externalReferences: [ExternalReferencesInner]? = nil, germplasmDbId: String? = nil, germplasmName: String? = nil, observationTimeStamp: Date? = nil, observationUnitDbId: String? = nil, observationUnitName: String? = nil, observationVariableDbId: String? = nil, observationVariableName: String? = nil, season: ObservationSeason? = nil, studyDbId: String? = nil, uploadedBy: String? = nil, value: String? = nil) {
