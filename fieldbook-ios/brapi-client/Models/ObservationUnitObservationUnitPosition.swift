//
// ObservationUnitObservationUnitPosition.swift
//
...
public struct ObservationUnitObservationUnitPosition: Codable {
    ...
    public var observationLevel: ObservationUnitLevelRelationship2?
    ...
    public init(entryType: EntryType? = nil, geoCoordinates: GeoJSON? = nil, observationLevel: ObservationUnitLevelRelationship2? = nil, observationLevelRelationships: [ObservationUnitLevelRelationship1]? = nil, positionCoordinateX: String? = nil, positionCoordinateXType: PositionCoordinateXType? = nil, positionCoordinateY: String? = nil, positionCoordinateYType: PositionCoordinateYType? = nil) {
