...
public struct Location: Codable {
    ...
    public init(abbreviation: String? = nil, additionalInfo: [String:String]? = nil, coordinateDescription: String? = nil, coordinateUncertainty: String? = nil, coordinates: GeoJSON? = nil, countryCode: String? = nil, countryName: String? = nil, documentationURL: String? = nil, environmentType: String? = nil, exposure: String? = nil, externalReferences: [ExternalReferencesInner]? = nil, instituteAddress: String? = nil, instituteName: String? = nil, locationDbId: String? = nil, locationName: String? = nil, locationType: String? = nil, siteStatus: String? = nil, slope: String? = nil, topography: String? = nil) {
