...
public struct LocationSearchRequest: Codable {
    ...
    public var coordinates: GeoJSONSearchArea?
    ...
    public init(abbreviations: [String]? = nil, altitudeMax: Decimal? = nil, altitudeMin: Decimal? = nil, coordinates: GeoJSONSearchArea? = nil, countryCodes: [String]? = nil, countryNames: [String]? = nil, externalReferenceIDs: [String]? = nil, externalReferenceSources: [String]? = nil, instituteAddresses: [String]? = nil, instituteNames: [String]? = nil, locationDbIds: [String]? = nil, locationNames: [String]? = nil, locationTypes: [String]? = nil, page: Int? = nil, pageSize: Int? = nil) {
