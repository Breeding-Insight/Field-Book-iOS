...
public struct ObservationUnit: Codable {
    ...
    public var observationUnitPosition: ObservationUnitObservationUnitPosition?
    ...
    public var observations: [ObservationUnitObservations]?
    ...
    public var treatments: [ObservationUnitTreatments]?
    ...
    public init(additionalInfo: [String:String]? = nil, externalReferences: [ExternalReferencesInner]? = nil, germplasmDbId: String? = nil, germplasmName: String? = nil, locationDbId: String? = nil, locationName: String? = nil, observationUnitDbId: String? = nil, observationUnitName: String? = nil, observationUnitPUI: String? = nil, observationUnitPosition: ObservationUnitObservationUnitPosition? = nil, observations: [ObservationUnitObservations]? = nil, programDbId: String? = nil, programName: String? = nil, seedLotDbId: String? = nil, studyDbId: String? = nil, studyName: String? = nil, treatments: [ObservationUnitTreatments]? = nil, trialDbId: String? = nil, trialName: String? = nil) {
