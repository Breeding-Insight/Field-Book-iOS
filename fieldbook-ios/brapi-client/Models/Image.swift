...
public struct Image: Codable {
    ...
    public init(additionalInfo: [String:String]? = nil, copyright: String? = nil, _description: String? = nil, descriptiveOntologyTerms: [String]? = nil, externalReferences: [ExternalReferencesInner]? = nil, imageDbId: String? = nil, imageFileName: String? = nil, imageFileSize: Int? = nil, imageHeight: Int? = nil, imageLocation: GeoJSON? = nil, imageName: String? = nil, imageTimeStamp: Date? = nil, imageURL: String? = nil, imageWidth: Int? = nil, mimeType: String? = nil, observationDbIds: [String]? = nil, observationUnitDbId: String? = nil) {
