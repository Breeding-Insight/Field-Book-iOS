...
public struct TrialNewRequest: Codable {
    ...
    public init(active: Bool? = nil, additionalInfo: [String:String]? = nil, commonCropName: String? = nil, contacts: [StudyContacts]? = nil, datasetAuthorships: [TrialDatasetAuthorships]? = nil, documentationURL: String? = nil, endDate: Date? = nil, externalReferences: [ExternalReferencesInner]? = nil, programDbId: String? = nil, programName: String? = nil, publications: [TrialPublications]? = nil, startDate: Date? = nil, trialDescription: String? = nil, trialName: String? = nil, trialPUI: String? = nil) {
        self.active = active
