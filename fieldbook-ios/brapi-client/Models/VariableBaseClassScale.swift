...
public struct VariableBaseClassScale: Codable {
    ...
    public init(additionalInfo: [String:String]? = nil, dataType: DataType? = nil, decimalPlaces: Int? = nil, externalReferences: [ExternalReferencesInner]? = nil, ontologyReference: MethodBaseClassOntologyReference? = nil, scaleDbId: String? = nil, scaleName: String? = nil, validValues: ScaleBaseClassValidValues? = nil) {
