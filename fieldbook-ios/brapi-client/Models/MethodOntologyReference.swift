...
public struct MethodOntologyReference: Codable {

    /** links to various ontology documentation */
    public var documentationLinks: [MethodOntologyReferenceDocumentationLinks]?
    ...
    public init(documentationLinks: [MethodOntologyReferenceDocumentationLinks]? = nil, ontologyDbId: String, ontologyName: String, version: String? = nil) {
