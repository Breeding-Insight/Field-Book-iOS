...
public struct VariableBaseClassTrait: Codable {
    ...
    public var ontologyReference: MethodBaseClassOntologyReference?
    ...
    public init(additionalInfo: [String:String]? = nil, alternativeAbbreviations: [String]? = nil, attribute: String? = nil, entity: String? = nil, externalReferences: [ExternalReferencesInner]? = nil, mainAbbreviation: String? = nil, ontologyReference: MethodBaseClassOntologyReference? = nil, status: String? = nil, synonyms: [String]? = nil, traitClass: String? = nil, traitDbId: String? = nil, traitDescription: String? = nil, traitName: String? = nil) {
