...
public struct VariableBaseClass: Codable {
    ...
    public var externalReferences: ExternalReferences?
    ...
    public var method: VariableBaseClassMethod
    public var ontologyReference: OntologyReference?
    public var scale: VariableBaseClassScale
    ...
    public var trait: VariableBaseClassTrait

    public init(additionalInfo: [String:String]? = nil, commonCropName: String? = nil, contextOfUse: [String]? = nil, defaultValue: String? = nil, documentationURL: String? = nil, externalReferences: ExternalReferences? = nil, growthStage: String? = nil, institution: String? = nil, language: String? = nil, method: VariableBaseClassMethod, ontologyReference: OntologyReference? = nil, scale: VariableBaseClassScale, scientist: String? = nil, status: String? = nil, submissionTimestamp: Date? = nil, synonyms: [String]? = nil, trait: VariableBaseClassTrait) {
