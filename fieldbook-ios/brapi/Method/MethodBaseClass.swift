...
public struct MethodBaseClass: Codable {
    ...
    public init(additionalInfo: [String:String]? = nil, bibliographicalReference: String? = nil, _description: String? = nil, externalReferences: [ExternalReferencesInner]? = nil, formula: String? = nil, methodClass: String? = nil, methodName: String? = nil, ontologyReference: OntologyReference? = nil) {
