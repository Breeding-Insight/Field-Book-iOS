...
public struct ObservationUnitSearchRequest: Codable {
    ...
    public init(externalReferenceIDs: [String]? = nil, externalReferenceSources: [String]? = nil, germplasmDbIds: [String]? = nil, germplasmNames: [String]? = nil, includeObservations: Bool? = nil, locationDbIds: [String]? = nil, locationNames: [String]? = nil, observationLevelRelationships: [ObservationUnitHierarchyLevel]? = nil, observationLevels: [ObservationUnitHierarchyLevel]? = nil, observationUnitDbIds: [String]? = nil, observationVariableDbIds: [String]? = nil, observationVariableNames: [String]? = nil, page: Int? = nil, pageSize: Int? = nil, programDbIds: [String]? = nil, programNames: [String]? = nil, studyDbIds: [String]? = nil, studyNames: [String]? = nil, trialDbIds: [String]? = nil, trialNames: [String]? = nil) {
