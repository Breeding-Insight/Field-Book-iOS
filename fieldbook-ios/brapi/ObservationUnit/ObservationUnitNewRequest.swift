...
public struct ObservationUnitNewRequest: Codable {
    ...
    public init(additionalInfo: [String:String]? = nil, externalReferences: [ExternalReferencesInner]? = nil, germplasmDbId: String? = nil, germplasmName: String? = nil, locationDbId: String? = nil, locationName: String? = nil, observationUnitName: String? = nil, observationUnitPUI: String? = nil, observationUnitPosition: ObservationUnitPosition? = nil, programDbId: String? = nil, programName: String? = nil, seedLotDbId: String? = nil, studyDbId: String? = nil, studyName: String? = nil, treatments: [Treatment]? = nil, trialDbId: String? = nil, trialName: String? = nil) {
