...
open class ServerInfoAPI {
     ...
     */
    open func serverinfoGet(dataType: WSMIMEDataTypes? = nil, authorization: String? = nil, completion: @escaping ((_ data: BrAPIServerInfoResponse?,_ error: Error?) -> Void)) {
  ...
  "@context" : [ "https://brapi.org/jsonld/context/metadata.jsonld" ]
     ...
     - returns: RequestBuilder<BrAPIServerInfoResponse>
     */
    open func serverinfoGetWithRequestBuilder(dataType: WSMIMEDataTypes? = nil, authorization: String? = nil) -> RequestBuilder<BrAPIServerInfoResponse> {
        let path = "/serverinfo"
        ...
        let requestBuilder: RequestBuilder<BrAPIServerInfoResponse>.Type = BrAPIClientAPI.requestBuilderFactory.getBuilder()
