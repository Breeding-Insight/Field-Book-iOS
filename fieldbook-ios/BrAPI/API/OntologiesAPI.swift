...
open class OntologiesAPI {
     ...
     */
    open func ontologiesGet(ontologyDbId: String? = nil, page: Int? = nil, pageSize: Int? = nil, authorization: String? = nil, completion: @escaping ((_ data: BrAPIOntologyListResponse?,_ error: Error?) -> Void)) {
  ...
  "@context" : [ "https://brapi.org/jsonld/context/metadata.jsonld" ]
     ...
     - returns: RequestBuilder<BrAPIOntologyListResponse>
     */
    open func ontologiesGetWithRequestBuilder(ontologyDbId: String? = nil, page: Int? = nil, pageSize: Int? = nil, authorization: String? = nil) -> RequestBuilder<BrAPIOntologyListResponse> {
        let path = "/ontologies"
        ...
        let requestBuilder: RequestBuilder<BrAPIOntologyListResponse>.Type = BrAPIClientAPI.requestBuilderFactory.getBuilder()
