...
public struct MethodBaseClassOntologyReference: Codable {
    ...
    public var documentationLinks: [OntologyReferenceDocumentationLinks]?
    ...
    public init(documentationLinks: [OntologyReferenceDocumentationLinks]? = nil, ontologyDbId: String, ontologyName: String, version: String? = nil) {
