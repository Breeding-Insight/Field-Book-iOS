...
public struct BrAPIObservationTable: Codable {

    public enum HeaderRow: String, Codable { 
        case observationtimestamp = "observationTimeStamp"
    ...
    public var observationVariables: [BrAPIObservationTableObservationVariables]?

    public init(data: [[String]]? = nil, headerRow: [HeaderRow]? = nil, observationVariables: [BrAPIObservationTableObservationVariables]? = nil) {
        self.data = data
