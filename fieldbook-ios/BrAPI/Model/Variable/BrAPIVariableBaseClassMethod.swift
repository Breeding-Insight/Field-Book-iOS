...
public struct BrAPIVariableBaseClassMethod: Codable {
    ...
    public init(additionalInfo: [String:String]? = nil, bibliographicalReference: String? = nil, _description: String? = nil, externalReferences: [BrAPIExternalReferencesInner]? = nil, formula: String? = nil, methodClass: String? = nil, methodDbId: String? = nil, methodName: String? = nil, ontologyReference: BrAPIOntologyReference? = nil) {
