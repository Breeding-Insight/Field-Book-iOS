...
public struct BrAPIEvent: Codable {
    ...
    public var eventParameters: [BrAPIEventEventParameters]?
    ...
    public init(additionalInfo: [String:String]? = nil, date: [Date]? = nil, eventDbId: String, eventDescription: String? = nil, eventParameters: [BrAPIEventEventParameters]? = nil, eventType: String, eventTypeDbId: String? = nil, observationUnitDbIds: [String]? = nil, studyDbId: String? = nil) {
