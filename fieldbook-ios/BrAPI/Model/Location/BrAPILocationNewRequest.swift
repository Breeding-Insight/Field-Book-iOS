...
public struct BrAPILocationNewRequest: Codable {
    ...
    public init(abbreviation: String? = nil, additionalInfo: [String:String]? = nil, coordinateDescription: String? = nil, coordinateUncertainty: String? = nil, coordinates: BrAPIGeoJSON? = nil, countryCode: String? = nil, countryName: String? = nil, documentationURL: String? = nil, environmentType: String? = nil, exposure: String? = nil, externalReferences: [BrAPIExternalReferencesInner]? = nil, instituteAddress: String? = nil, instituteName: String? = nil, locationName: String? = nil, locationType: String? = nil, siteStatus: String? = nil, slope: String? = nil, topography: String? = nil) {
