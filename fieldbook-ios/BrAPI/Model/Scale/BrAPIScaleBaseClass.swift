...
public struct BrAPIScaleBaseClass: Codable {
    ...
    public init(additionalInfo: [String:String]? = nil, dataType: DataType? = nil, decimalPlaces: Int? = nil, externalReferences: [BrAPIExternalReferencesInner]? = nil, ontologyReference: BrAPIOntologyReference? = nil, scaleName: String, validValues: BrAPIScaleValidValues? = nil) {
