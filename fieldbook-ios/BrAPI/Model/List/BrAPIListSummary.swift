...
public struct BrAPIListSummary: Codable {
    ...
    public init(additionalInfo: [String:String]? = nil, dateCreated: Date? = nil, dateModified: Date? = nil, externalReferences: [BrAPIExternalReferencesInner]? = nil, listDbId: String? = nil, listDescription: String? = nil, listName: String? = nil, listOwnerName: String? = nil, listOwnerPersonDbId: String? = nil, listSize: Int? = nil, listSource: String? = nil, listType: ListType? = nil) {
