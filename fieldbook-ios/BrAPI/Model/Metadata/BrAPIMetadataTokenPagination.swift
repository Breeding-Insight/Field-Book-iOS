...
public struct BrAPIMetadataTokenPagination: Codable {
    ...
    public var pagination: BrAPIMetadataTokenPaginationPagination?
    ...
    public init(datafiles: [BrAPIMetadataDatafiles]? = nil, pagination: BrAPIMetadataTokenPaginationPagination? = nil, status: [BrAPIMetadataStatus]? = nil) {
