...
public struct BrAPIImage: Codable {
    ...
    public var imageLocation: BrAPIGeoJSON?
    ...
    public init(additionalInfo: [String:String]? = nil, copyright: String? = nil, _description: String? = nil, descriptiveOntologyTerms: [String]? = nil, externalReferences: [BrAPIExternalReferencesInner]? = nil, imageDbId: String? = nil, imageFileName: String? = nil, imageFileSize: Int? = nil, imageHeight: Int? = nil, imageLocation: BrAPIGeoJSON? = nil, imageName: String? = nil, imageTimeStamp: Date? = nil, imageURL: String? = nil, imageWidth: Int? = nil, mimeType: String? = nil, observationDbIds: [String]? = nil, observationUnitDbId: String? = nil) {
