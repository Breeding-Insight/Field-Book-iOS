...
public struct BrAPIProgram: Codable {
    ...
    public init(abbreviation: String? = nil, additionalInfo: [String:String]? = nil, commonCropName: String? = nil, documentationURL: String? = nil, externalReferences: [BrAPIExternalReferencesInner]? = nil, leadPersonDbId: String? = nil, leadPersonName: String? = nil, objective: String? = nil, programDbId: String? = nil, programName: String? = nil) {
