...
public struct BrAPIObservationUnitPosition: Codable {
    ...
    public var geoCoordinates: BrAPIGeoJSON?
    public var observationLevel: BrAPIObservationUnitHierarchyLevel?
    ...
    public var observationLevelRelationships: [BrAPIObservationUnitHierarchyLevel]?
    ...
    public var positionCoordinateXType: PositionCoordinateType?
    ...
    /** The type of positional coordinate used. Must be one of the following values  LONGITUDE - ISO 6709 standard, WGS84 geodetic datum. See &#x27;Location Coordinate Encoding&#x27; for details  LATITUDE - ISO 6709 standard, WGS84 geodetic datum. See &#x27;Location Coordinate Encoding&#x27; for details  PLANTED_ROW - The physical planted row number   PLANTED_INDIVIDUAL - The physical counted number, could be independant or within a planted row  GRID_ROW - The row index number of a square grid overlay  GRID_COL - The column index number of a square grid overlay  MEASURED_ROW - The distance in meters from a defined 0-th row  MEASURED_COL - The distance in meters from a defined 0-th column */
    public var positionCoordinateYType: PositionCoordinateType?

    public init(entryType: EntryType? = nil, geoCoordinates: BrAPIGeoJSON? = nil, observationLevel: BrAPIObservationUnitHierarchyLevel? = nil, observationLevelRelationships: [BrAPIObservationUnitHierarchyLevel]? = nil, positionCoordinateX: String? = nil, positionCoordinateXType: PositionCoordinateType? = nil, positionCoordinateY: String? = nil, positionCoordinateYType: PositionCoordinateType? = nil) {
