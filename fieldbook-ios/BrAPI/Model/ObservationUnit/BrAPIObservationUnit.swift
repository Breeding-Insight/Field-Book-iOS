...
public struct BrAPIObservationUnit: Codable {
    ...
    public var observations: [BrAPIObservation]?
    ...
    public init(additionalInfo: [String:String]? = nil, externalReferences: [BrAPIExternalReferencesInner]? = nil, germplasmDbId: String? = nil, germplasmName: String? = nil, locationDbId: String? = nil, locationName: String? = nil, observationUnitDbId: String? = nil, observationUnitName: String? = nil, observationUnitPUI: String? = nil, observationUnitPosition: BrAPIObservationUnitPosition? = nil, observations: [BrAPIObservation] = Array(), programDbId: String? = nil, programName: String? = nil, seedLotDbId: String? = nil, studyDbId: String? = nil, studyName: String? = nil, treatments: [BrAPITreatment]? = [], trialDbId: String? = nil, trialName: String? = nil) {
