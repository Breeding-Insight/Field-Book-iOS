...
public struct BrAPIStudy: Codable {
    ...
    public var contacts: [BrAPIContact]?
    ...
    public var dataLinks: [BrAPIDataLink]?
    ...
    public var environmentParameters: [BrAPIEnvironmentParameter]?
    public var experimentalDesign: BrAPIStudyExperimentalDesign?
    /** An array of external reference ids. These are references to this piece of data in an external system. Could be a simple string or a URI. */
    public var externalReferences: [BrAPIExternalReferencesInner]?
    public var growthFacility: BrAPIStudyGrowthFacility?
    public var lastUpdate: BrAPIStudyLastUpdate?
    ...
    public var observationLevels: [BrAPIObservationUnitHierarchyLevel]?
    ...
    public init(active: Bool? = nil, additionalInfo: [String:String]? = nil, commonCropName: String? = nil, contacts: [BrAPIContact]? = nil, culturalPractices: String? = nil, dataLinks: [BrAPIDataLink]? = nil, documentationURL: String? = nil, endDate: Date? = nil, environmentParameters: [BrAPIEnvironmentParameter]? = nil, experimentalDesign: BrAPIStudyExperimentalDesign? = nil, externalReferences: [BrAPIExternalReferencesInner]? = nil, growthFacility: BrAPIStudyGrowthFacility? = nil, lastUpdate: BrAPIStudyLastUpdate? = nil, license: String? = nil, locationDbId: String? = nil, locationName: String? = nil, observationLevels: [BrAPIObservationUnitHierarchyLevel]? = nil, observationUnitsDescription: String? = nil, seasons: [String]? = nil, startDate: Date? = nil, studyCode: String? = nil, studyDbId: String? = nil, studyDescription: String? = nil, studyName: String? = nil, studyPUI: String? = nil, studyType: String? = nil, trialDbId: String? = nil, trialName: String? = nil) {
        self.active = active
