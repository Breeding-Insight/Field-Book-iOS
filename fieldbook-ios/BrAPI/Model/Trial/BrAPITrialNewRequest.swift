...
public struct BrAPITrialNewRequest: Codable {
    ...
    public var datasetAuthorships: [BrAPITrialDatasetAuthorships]?
    ...
    public var publications: [BrAPITrialPublications]?
    ...
    public init(active: Bool? = nil, additionalInfo: [String:String]? = nil, commonCropName: String? = nil, contacts: [BrAPIContact]? = nil, datasetAuthorships: [BrAPITrialDatasetAuthorships]? = nil, documentationURL: String? = nil, endDate: Date? = nil, externalReferences: [BrAPIExternalReferencesInner]? = nil, programDbId: String? = nil, programName: String? = nil, publications: [BrAPITrialPublications]? = nil, startDate: Date? = nil, trialDescription: String? = nil, trialName: String? = nil, trialPUI: String? = nil) {
        self.active = active
