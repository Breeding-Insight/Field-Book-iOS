...
public struct BrAPIPerson: Codable {
    ...
    public init(additionalInfo: [String:String]? = nil, _description: String? = nil, emailAddress: String? = nil, externalReferences: [BrAPIExternalReferencesInner]? = nil, firstName: String? = nil, lastName: String? = nil, mailingAddress: String? = nil, middleName: String? = nil, personDbId: String? = nil, phoneNumber: String? = nil, userID: String? = nil) {
